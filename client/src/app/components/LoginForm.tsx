  ...
  return (
    <div className={Styles.loginFormContainer}>
      <form className={Styles.form}>
        <Image src={instagramFont} alt="image" width={180} height={60} className={Styles.instagramFont}/>
      ...
      <div className={Styles.getApp}>
        ...
        <div>
          <a href="https://play.google.com/store/apps/details?id=com.instagram.android">
            <Image src={asset6} alt="playstore" width={70} height={30} />
          </a>
          <a href='ms-windows-store://pdp/?productid=9nblggh5l9xt&amp;referrer=appbadge&amp;source=www.instagram.com&amp;mode=mini&amp;pos=0%2C0%2C1920%2C1032" rel="nofollow noreferrer'>
            <Image src={asset7} alt="playstore" width={70} height={30} />
          </a>
        </div>
      </div>
    </div>
