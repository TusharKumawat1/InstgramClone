...
export default function Step4() {
  const { images, setPostSteps, aspectRatio, authenticUser, appliedFilters ,generateBase64,getImageUrl} =
      ...
      <div className={Styles.mainContainer}>
        ...
        <div className={step4.postDetailsSection}>
          ...
          {showEmojiPicker && (
            <ClickAwayListener onClickAway={() => setshowEmojiPicker(false)}>
              <div className={step4.emojiPicker}>
                <EmojiPicker height={400} onEmojiClick={setEmojiToCaption} />
              </div>
            </ClickAwayListener>
          )}
          <div className={step4.locationContainer}>
            ...
            {showLocations &&  (
            <ClickAwayListener onClickAway={()=>setShowLocations(false)}>
                      ...
                      <label className={step4.switch}>
                        <input
                          ...
                          onChange={(e) => {
                            const newObj = {
                              ...advancedSetting,
                              hideLikeAndView: e.target.checked ? true : false,
                            };
